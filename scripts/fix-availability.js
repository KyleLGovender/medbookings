...
async function main() {
  ...
  sampleRecords.forEach((record, index) => {
    ...
    console.log(`     createdById matches provider userId: ${record.createdById === record.userId ? '✅' : '❌'}`);
    console.log('');
  });
  ...
  if (remainingCount === 0) {
    ...
    console.log('🎉 You should now be able to edit your provider-created availabilities in the calendar.');
  } else {
