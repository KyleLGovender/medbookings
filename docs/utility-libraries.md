...
const url = 'https://blob.vercel-storage.com/documents/uuid-|-license-|-20240115-143000-|-medical-license.pdf';
const filename = extractFilenameFromUrl(url);
// Returns: 'medical-license.pdf'

// URL with legacy naming convention
const legacyUrl = 'https://blob.vercel-storage.com/documents/uuid-%7C-license-%7C-20240115-143000-%7C-medical-license.pdf';
