...
import { AlertTriangle, ArrowLeft, Building, Home, Lock, Shield, Users } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8">
        <Card>
          ...
          <CardContent className="space-y-6">
            <p className="text-center text-gray-600">{errorDetails.description}</p>
            ...
            {attemptedRoute && (
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <br />
                  <span className="font-mono text-sm text-muted-foreground">{attemptedRoute}</span>
                </AlertDescription>
              </Alert>
            )}
