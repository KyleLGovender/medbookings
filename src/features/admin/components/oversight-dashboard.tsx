                    ...
                    <TableRow key={provider.id}>
                      ...
                      <TableCell>
                        <div className='flex items-center gap-2'>
                          <Badge variant={
                            provider.requirementsStatus === 'complete' ? 'default' :
                            provider.requirementsStatus === 'rejected' ? 'destructive' : 'secondary'
                          }>
                            ...
                            <Dialog>
                              ...
                              <DialogContent>
                                ...
                                <DialogFooter>
                                  ...
                                  <Button
                                    onClick={() => handleApprovalAction('provider', provider.id, 'approve')}
                            ...
                            <Dialog>
                              ...
                              <DialogContent>
                                ...
                                <DialogFooter>
                                  ...
                                  <Button
                                    variant='destructive'
                                    onClick={() => handleApprovalAction('provider', provider.id, 'reject')}
                          ...
                          {canApproveOrganizations && (
                            <>
                              <Button
                                variant='default'
                                size='sm'
                                onClick={() => handleApprovalAction('organization', org.id, 'approve')}
                              >
                                <CheckCircle className='h-4 w-4 mr-1' />
                                Approve
                              </Button>
                              ...
                              <Button
                                variant='destructive'
                                size='sm'
                                onClick={() => handleApprovalAction('organization', org.id, 'reject')}
                              >
                                <XCircle className='h-4 w-4 mr-1' />
                                Reject
                              </Button>
