...
export function isValidRequirementSubmission(value: unknown): value is {
  ...
  return (
    ...
    (!(value as any).documentMetadata ||
      (value as any).documentMetadata === null ||
      typeof (value as any).documentMetadata === 'object') &&
...
export function isValidProviderConnection(value: unknown): value is {
  ...
  return (
    ...
    (!(value as any).acceptedAt ||
      (value as any).acceptedAt === null ||
      isValidDateString((value as any).acceptedAt)) &&
    (!(value as any).suspendedAt ||
      (value as any).suspendedAt === null ||
      isValidDateString((value as any).suspendedAt))
  );
}
...
export function isValidBooleanValidationConfig(value: unknown): value is {
  ...
  return (
    ...
    (!(value as any).defaultValue ||
      (value as any).defaultValue === null ||
      typeof (value as any).defaultValue === 'boolean') &&
