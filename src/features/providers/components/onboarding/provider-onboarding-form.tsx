...
export function ProviderOnboardingForm() {
  ...
  const handleInvalidSubmit = () => {
    const errors = Object.entries(methods.formState.errors)
      .flatMap(([key, value]) => {
        if (key === "basicInfo" || key === "providerType" || key === "professionalDetails" || key === "services") {
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-md text-sm">
              <p className="mb-2">
                By submitting this application, I confirm that all information provided is accurate and complete to the
                best of my knowledge.
              </p>
              <p>
                I understand that my application will be reviewed by MedBookings staff and that I may be contacted for
                additional information or verification. I agree to provide any requested documentation in a timely
                manner.
              </p>
            </div>
        ...
        <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to submit your provider application? Once submitted, you'll need to contact
