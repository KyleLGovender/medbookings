...
import { Briefcase, CheckCircle, FileText, Send, Shield, Stethoscope, User } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {basicInfo.bio && (
            <div>
              <h5 className="mb-2 font-medium">Professional Bio</h5>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {services.availableServices && services.availableServices.length > 0 && (
            <div>
              <h5 className="mb-2 font-medium">Available Services</h5>
          ...
          {services.customServices && services.customServices.length > 0 && (
            <div>
              <h5 className="mb-2 font-medium">Custom Services</h5>
              <div className="flex flex-wrap gap-2">
