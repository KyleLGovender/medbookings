...
export function RegulatoryRequirementsSection() {
  ...
  const requirements = providerType
    ? REGULATORY_REQUIREMENTS[providerType as keyof typeof REGULATORY_REQUIREMENTS] || REGULATORY_REQUIREMENTS.default
    : []
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Badge variant={completedRequired === requiredRequirements.length ? "default" : "secondary"}>
