...
import { DeleteServiceProviderButton } from '@/features/admin/components/providers/delete-service-provider-button';
import { EditServiceProviderButton } from '@/features/admin/components/providers/edit-service-provider-button';
