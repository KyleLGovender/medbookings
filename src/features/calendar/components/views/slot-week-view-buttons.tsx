...
export function SlotWeekViewButtons({
  currentDate,
  events,
  workingHours,
  onEventClick,
  ...
  // Calculate display time range based on actual slot times
  const getDisplayTimeRange = () => {
    // If no events, show default business hours
    if (events.length === 0) {
