...
export const ORGANIZATION_ROLE_HIERARCHIES: Record<OrganizationRole, RoleHierarchy> = {
  ...
  [OrganizationRole.MANAGER]: {
    ...
    permissions: [Permission.PROPOSE_AVAILABILITY, Permission.MANAGE_BOOKINGS],
  },
...
export function roleInheritsFrom(role: UserRole, inheritedRole: UserRole): boolean {
  ...
  return hierarchy.inherits.some((parentRole) => roleInheritsFrom(parentRole, inheritedRole));
}
 ...
 */
export function isHigherOrganizationRole(
