...
4. **Save PRD:** Save the generated document as `[feature-name]-prd.md` inside the `/project-planning/prd` directory.

## Clarifying Questions (Examples)

The AI should adapt its questions based on the prompt, but here are some common areas to explore:

- **Feature Name:** Suggest a name for the feature and ask "Is this a good name for the feature? If it isn't please suggest a better name"
