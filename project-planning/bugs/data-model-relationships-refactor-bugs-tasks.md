...
- [ ] 1.0 🔴 **CRITICAL**: Add Database Constraint for Subscription Polymorphic Relationship
  ...
  - [ ] 1.2 Add application-level validation in subscription creation API endpoints in `src/app/api/subscriptions/`
  - [ ] 1.3 Add application-level validation in subscription update API endpoints
