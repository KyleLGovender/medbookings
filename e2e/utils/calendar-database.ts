...
/**
 * Clean ONLY calendar test data from database
 * Identifies test data by E2E_CALENDAR prefixes
 */
...
/**
 * Create minimal test data needed for calendar testing
 */
...
/**
 * Get count of calendar test data records for verification
 */
...
/**
 * Setup complete calendar test environment
 */
export async function setupCalendarTestEnvironment() {
  // Clean any existing calendar test data
