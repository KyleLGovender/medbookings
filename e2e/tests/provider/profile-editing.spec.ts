...
test.describe('Provider Profile Editing', () => {
  ...
  test.describe('Basic Information Editing', () => {
    test('should display current provider information', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="bio"]')).toHaveValue(
    ...
    test('should validate years of experience', async ({ page }) => {
      ...
      // Should show validation error
      await expect(page.locator('[data-testid="yearsOfExperience-error"]')).toContainText(
  ...
  test.describe('Services Management', () => {
    ...
    test('should add service with custom pricing', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="service-config-General Consultation"]')
      ).toBeVisible();
      ...
      // Should show success message
      await expect(page.locator('[data-testid="services-save-success"]')).toContainText(
        'Services updated successfully'
      );

      // Verify service is enabled
      await expect(page.locator('[data-testid="service-General Consultation"]')).toHaveClass(
        /enabled/
      );
    });
    ...
    test('should configure service availability types', async ({ page }) => {
      ...
      await serviceCard.click();
      await expect(
        page.locator('[data-testid="online-available-General Consultation"]')
      ).toBeChecked();
      await expect(
        page.locator('[data-testid="in-person-available-General Consultation"]')
      ).toBeChecked();
    });
    ...
    test('should disable service', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="service-General Consultation"]')).not.toHaveClass(
        /enabled/
      );
    });
  });
  ...
  test.describe('Regulatory Requirements', () => {
    test('should display requirement submission status', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="requirement-Professional Insurance"]')
      ).toBeVisible();
    ...
    test('should upload requirement document', async ({ page }) => {
      ...
      // Should show success message
      await expect(page.locator('[data-testid="upload-success-Medical License"]')).toContainText(
        'Document uploaded successfully'
      );

      // Should update requirement status
      await expect(
        page.locator('[data-testid="requirement-status-Medical License"]')
    ...
    test('should replace existing requirement document', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="replace-success-Medical License"]')).toContainText(
    ...
    test('should show requirement approval status', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="approval-checkmark-Medical License"]')
      ).toBeVisible();
    });
  });
  ...
  test.describe('Profile Navigation', () => {
    ...
    test('should show unsaved changes warning', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="unsaved-changes-message"]')).toContainText(
