...
To perform DEEP technical analysis with maximum cognitive effort ("Think hardest" mode) and create a detailed implementation plan BEFORE creating PRP/Issue documents.
...
3. **Deep Thinking Technical Discovery Phase**
...
4. **Name Determination Based on Technical Scope**
...
5. **Generate Technical Plan with Deep Thinking**
...
6. **Generate PRP Intelligence Section**

- Extract patterns from similar features
- Document import conventions
- List validation requirements
- Include test patterns from existing tests
...
- This command will generate the PRP/Issue spec and task list when you're ready
