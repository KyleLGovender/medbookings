...
-- CreateEnum
CREATE TYPE "BookingCreatorType" AS ENUM ('GUEST', 'USER', 'SERVICE_PROVIDER', 'ADMIN');

-- CreateEnum
CREATE TYPE "BookingRelationType" AS ENUM ('SELF', 'DEPENDENT', 'GUEST', 'PROFESSIONAL');
...
-- CreateIndex
CREATE INDEX "Booking_serviceProviderId_status_idx" ON "Booking"("serviceProviderId", "status");
